...
app.post("/sheets/editorial/append", async (req, res) => {
  ...
  return res.json({ updated_range: `${sheet_name}!A1:F${rows.length}`, web_link: `https://docs.google.com/spreadsheets/d/${spreadsheet_id}` });
});
